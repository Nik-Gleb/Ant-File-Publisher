...
public class Endpoints {
    ...
    public static <T> T convert(Class<?> type, HttpURLConnection in) throws IOException {
    ...
    public static EndpointConnection<HttpURLConnection> custom(String url, SkypeImpl skype, String... args) {
        ...
        return new EndpointConnection<Object>(new Endpoints(url), skype, args).as(HttpURLConnection.class);
    }
    ...
    public EndpointConnection<HttpURLConnection> open(SkypeImpl skype, Object... args) {
        ...
        return new EndpointConnection<Object>(this, skype, args).as(HttpURLConnection.class);
    }
    ...
    public static class EndpointConnection<E_TYPE> {
        ...
        public EndpointConnection<E_TYPE> expect(Predicate<Integer> check, String cause) {
            ...
            return on(check, (connection) -> {
                return convert(clazz, connection);
            });
        }
